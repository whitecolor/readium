...
Readium.Models.MediaOverlay = Backbone.Model.extend({
    ...
    initialize: function() {
        var self = this;
        this.audioplayer = new Readium.Models.MediaOverlay.AudioClipPlayer();
    ...
    parse: function(xml) {
        var self = this;
        this.smilModel = new Readium.Models.MediaOverlay.SmilModel();
...
Readium.Models.MediaOverlay.SmilModel = function() {
...
Readium.Models.MediaOverlay.AudioClipPlayer = function() {
